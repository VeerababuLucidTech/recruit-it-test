    ...
    <>
      ...
      <div className="company-layout-bg rounded p-3 h-auto">
        ...
        <Checkbox
          ...
          onChange={(e) => setExpireReminder(e.checked)}
        />
      ...
      <div className="company-layout-bg rounded p-3 h-auto mb-6 mt-4">
        ...
        <div className="company-main-text">
          ...
          ad accusamus reprehenderit! Cum molestiae, architecto placeat fuga,
          velit accusantium suscipit asperiores sed quaerat necessitatibus
        </div>
      </div>
    </>
  );
