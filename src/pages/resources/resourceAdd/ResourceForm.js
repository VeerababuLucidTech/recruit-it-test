...
const ResourceForm = ({ onNext, initialData, setValue }) => {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            ssnNumber: initialData.ssnNumber || '',
            ...
            <div className="steps-form-container">
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className='flex flex-wrap gap-3 p-fluid'>
                        ...
                        <div className='row mb-2'>
                            <div className="flex-auto col-md-4">
                                <RequiredLabel label="SSN Number" required />
                                <InputMask
                                    id="ssnNumber"
                                    name="ssnNumber"
                                    ...
                                    mask="999-99-9999"
                                    className={formik.errors.ssnNumber && formik.touched.ssnNumber ? 'p-invalid' : ''}
                                />
                                {formik.errors.ssnNumber && formik.touched.ssnNumber && (
                                    <small className="p-error">{formik.errors.ssnNumber}</small>
                                )}
                            </div>
                            <div className="flex-auto col-md-4">
                                <RequiredLabel label="Primary Email ID" required />
                                <InputText
                                    id="email"
                                    name="email"
                        ...
                        <div className='row mb-2'>
                            <div className="flex-auto col-md-6">
                                <RequiredLabel label="Work Authorization" required />
                                <Dropdown
                                    ...
                                    className={formik.errors.workAuthorization && formik.touched.workAuthorization ? 'p-invalid' : ''}
                                />
                                {formik.errors.workAuthorization && formik.touched.workAuthorization && (
                                    <small className="p-error">{formik.errors.workAuthorization}</small>
                                )}
                            </div>
                            <div className="flex-auto col-md-6">
                                <RequiredLabel label="Resource Type" required />
                                <Dropdown
                                    id="resourceType"
                                    name="resourceType"
                                    ...
                                    className={formik.errors.resourceType && formik.touched.resourceType ? 'p-invalid' : ''}
                                />
